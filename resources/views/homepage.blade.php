...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets/img/icon/fav-icon.png') }}">
...
<body>
    ...
    <div class="smarthrlanding ">
                    ...
                    <div class="row">
                        ...
                        <div class="main-header-top" data-aos="fade-down" data-aos-duration="2000">
                            <div class="menu-header">
                                <div class="logo">
                                    <img src="{{ asset('assets/img/icon/logo.png') }}" alt="logo">
                                </div>
                                ...
                                <div class="try-free-link">
                                    <a class="btn btn-primary right-header-button" href="#contactus" role="button">Try It Free</a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Mobile Header -->
        <div class="mobile-heading-page">
            <header id="headers" class="site-header home-header home-header-while header-landing">
                <div class="container">
                    <div class="row">
                        <div class="main-menu-wrapper">
                            <div class="menu-header">
                                <a href="{{ url('/') }}" class="menu-logo">
                                    <img src="{{ asset('assets/img/icon/logo.png') }}" class="img-fluid" alt="Logo">
                                </a>
                            ...
                            <div class="try-free link mobile-head-menu">
                                <a class="btn btn-primary mobile-head-free-button" href="#contactus" role="button">Try It Free</a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-12 col-12 res-center">
                            <div class="site">
                                ...
                                <div class="site-brand">
                                    <a href="{{ url('/') }}" class="site-brand-logo"><img src="{{ asset('assets/img/icon/logo.png') }}" alt="logo" class="img-fluid"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-10 col-sm-10 col-9" data-aos="fade-up" data-aos-duration="2000">
                        <div class="admin-slider">
                            <div class="owl-carousel my-carousel bannercar">
                                <div class="my-carousel-item"><img src="{{ asset('assets/img/slider.png') }}" alt=""></div>
                                <div class="my-carousel-item"><img src="{{ asset('assets/img/slider-01.png') }}" alt=""></div>
                                <div class="my-carousel-item"><img src="{{ asset('assets/img/slider-02.png') }}" alt=""></div>
                                <div class="my-carousel-item"><img src="{{ asset('assets/img/slider-03.png') }}" alt=""></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-around feature-list">
                    <div class="col-lg-3 col-md-3 col-12">
                        <div class="feature-left">
                            <div class="feature-left-content" data-aos="fade-right" data-aos-duration="1000">
                                <div class="feat-box">
                                    <div class="feat-icon bg-orange">
                            ...
                            <div class="feature-left-content" data-aos="fade-right" data-aos-duration="2000">
                                <div class="feat-box">
                                    <div class="feat-icon bg-lightpink">
                    ...
                    <div class="col-lg-6 col-md-6 col-12 ">
                        <div class="feature-image" data-aos="fade-up" data-aos-duration="2000">
                            <img src="{{ asset('assets/img/featurebackground.png') }}" alt="features">
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-12 ">
                        <div class="feature-right">
                            <div class="feature-right-content" data-aos="fade-left" data-aos-duration="1000">
                                <div class="feat-box">
                                    <div class="feat-icon bg-orange">
                            ...
                            <div class="feature-right-content" data-aos="fade-left" data-aos-duration="2000">
                                <div class="feat-box">
                                    <div class="feat-icon bg-lightpink">
                                ...
                                <h4>Clean Codes</h4>
                                <p>Well tested, well documented and W3 validated code.<span> Developers can take advantage immediately.</span></p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-client" role="tabpanel" aria-labelledby="pills-home-tab">
                    <img src="{{ asset('assets/img/corefeatures.png') }}" alt="core-features">
                </div>
                <div class="tab-pane fade" id="pills-employee" role="tabpanel" aria-labelledby="pills-profile-tab">
                    <img src="{{ asset('assets/img/feature-02.png') }}" alt="core-features">
                </div>
                <div class="tab-pane fade" id="pills-project" role="tabpanel" aria-labelledby="pills-project-tab"><img src="{{ asset('assets/img/feature-03.png') }}" alt="core-features"></div>
                <div class="tab-pane fade" id="pills-video" role="tabpanel" aria-labelledby="pills-video-tab"><img src="{{ asset('assets/img/feature-05.png') }}" alt="core-features"></div>
                <div class="tab-pane fade" id="pills-audio" role="tabpanel" aria-labelledby="pills-audio-tab"><img src="{{ asset('assets/img/feature-04.png') }}" alt="core-features"></div>
            </div>
        </div>
    </div>
    <!-- / Tab Section -->
                ...
                <div class="feature-sections">
                    <div class="row" data-aos="fade-up" data-aos-duration="2000">
                        <div class="col-lg-4 col-md-4 d-flex">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/handshake.png') }}" alt="employee-management">
                        ...
                        <div class="col-lg-4 col-md-4 d-flex">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/people.png') }}" alt="payroll-management">
                        ...
                        <div class="col-lg-4 col-md-4 d-flex">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/innovation.png') }}" alt="project-management">
                    ...
                    <div class="row" data-aos="fade-up" data-aos-duration="2000">
                        <div class="col-lg-4 col-md-4 d-flex">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/notes.png') }}" alt="tas-management">
                        ...
                        <div class="col-lg-4 col-md-4  d-flex">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/management.png') }}" alt="jobs-management">
                        ...
                        <div class="col-lg-4 col-md-4 d-flex">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/timing.png') }}" alt="leads-management">
                    ...
                    <div class="row" data-aos="fade-up" data-aos-duration="2000">
                        <div class="col-lg-4 col-md-4 d-flex" data-aos="fade-up" data-aos-duration="14000">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/client.png') }}" alt="clients-management">
                        ...
                        <div class="col-lg-4 col-md-4 d-flex" data-aos="fade-up" data-aos-duration="8000">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/accounts.png') }}" alt="account-management">
                                    <h4>Account Management</h4>
                                    <p>It is a long established fact that a will be distracted.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 d-flex" data-aos="fade-up" data-aos-duration="9000">
                            <div class="management card flex-fill">
                                <div class="card-body">
                                    <img src="{{ asset('assets/img/customer-care.png') }}" alt="ticket-system">
                                    <h4>Ticket System</h4>
                                    <p>It is a long established fact that a will be distracted.</p>
                                </div>
                            </div>
    ...
    <!-- Pricing List -->
    <div class="pricing-detail" id="pricing">
        <div class="container">
            <div class="row">
                <div class="pricing-detail-content" data-aos="fade-up" data-aos-duration="2000">
                    <div class="commom-title-header d-flex justify-content-center">
                        <h2>Pricing Table</h2>
                    </div>
                            ...
                            <div class="free-plan card">
                                <div class="card-body price-plans">
                                    <div class="planimagebackground">
                                        <img src="{{ asset('assets/img/plan-Intersect.png') }}" alt="img">
                                    </div>
                                    <div class="planimagebackground-hidden">
                                        <img src="{{ asset('assets/img/hidden-intersect.png') }}" alt="img">
                                    </div>
                                    <div class="planimagecircleleft">
                                        <img src="{{ asset('assets/img/plan-circle-top.png') }}" alt="img">
                                    </div>
                                    <div class="planimagecircleright">
                                        <img src="{{ asset('assets/img/plan-circle-bottom.png') }}" alt="img">
                                    </div>
    ...
    <!-- Review Slider -->
    <div class="review-slider justify-content-center">
        <div class="review-section">
            <div class="container">
                <div class="row justify-content-center review-quoated-slider" data-aos="fade-up" data-aos-duration="1000">
                    <div class="col-lg-10 col-10 review-slider-back justify-content-center">
                        <div class="customer-reviews">
                            <div class="customer-re-background-left"></div>
                            <div class="customer-re-background-right"></div>

                            <div class="col-12 col-lg-12">
                                <div class="owl-carousel owl-theme cr-slider" id="owl-carousel">
                                    <div class="list-item text-center item ratings-slider">
                                        <div class="customer-quote"><img src="{{ asset('assets/img/quote-right.png') }}" alt="img"></div>
                                        <div class="customer-quote-one"><img src="{{ asset('assets/img/quote-left.png') }}" alt="img"></div>
                                ...
                                <div class="event-news">
                                    <div class="news-content">
                                        <div class="news-content-image">
                                            ...
                                            <a href="javascript:void(0)"><img src="{{ asset('assets/img/news-people.jpg') }}" alt="news-img"></a>
                                        </div>
                            ...
                            <div class="card-body news-events">
                                <div class="event-news">
                                    <div class="news-content">
                                        <div class="news-content-image">
                                            <button type="button" class="btn btn-info-news-event-bg">05 Sep</button>
                                            <a href="javascript:void(0)"><img src="{{ asset('assets/img/news-meeting.jpg') }}" alt="news-img"></a>
                                        </div>
                            ...
                            <div class="card-body news-events">
                                <div class="event-news">
                                    <div class="news-content">
                                        <div class="news-content-image">
                                            <button type="button" class="btn btn-info-news-event-bg">05 Sep</button>
                                            <a href="javascript:void(0)"><img src="{{ asset('assets/img/news-customer.jpg') }}" alt="news-img"></a>
                                        </div>
                ...
                <div class="subscribe-content" data-aos="fade-up" data-aos-duration="2000">
                    ...
                    <form method="post">
                        ...
                        <div class="input-group mb-3 mb-3 email-address">
                            <span class="input-group-text"><img src="{{ asset('assets/img/email.png') }}" alt="email-icon"></span>
                            ...
                            <button class="btn btn-success border-rad" id="button-addon2" type="submit">Subscribe</button>
                        </div>
                    </form>
                </div>
            </div>
            ...
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6">
                    <div class="copy-rights">
                        <p>Copyrights © {{ date('Y') }}. All Rights Reserved By Smart HR</p>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="company-logo">
                        <p>a product of <img src="{{ asset('assets/img/company-logo.png') }}" alt="Company-logo"></p>
                    </div>
                </div>
            </div>
        </div>
